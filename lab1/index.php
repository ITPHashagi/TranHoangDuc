            ...
            <div class="row">
                ...
                <div class="lblinput">
                    <select name="area" id="">
                        ...
                        $totalpoints = $area;
                        ?>
                        <option value="0" <?php echo $area == 0 ? "selected" : "" ?>>--Select an area--</option>
                        <option value="1" <?php echo $area == 1 ? "selected" : "" ?>>Area 1</option>
                        <option value="2" <?php echo $area == 2 ? "selected" : "" ?>>Area 2</option>
                        <option value="3" <?php echo $area == 3 ? "selected" : "" ?>>Area 3</option>
                        <option value="4" <?php echo $area == 4 ? "selected" : "" ?>>Area 4</option>
                        <option value="5" <?php echo $area == 5 ? "selected" : "" ?>>Area 5</option>
                    </select>
                </div>
            </div>
